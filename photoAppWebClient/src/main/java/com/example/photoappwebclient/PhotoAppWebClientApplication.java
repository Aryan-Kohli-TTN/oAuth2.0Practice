package com.example.photoappwebclient;
...
public class PhotoAppWebClientApplication {
    ...
    @Bean
    WebClient getWebclient(ClientRegistrationRepository clientRegistrationRepository, OAuth2AuthorizedClientRepository
